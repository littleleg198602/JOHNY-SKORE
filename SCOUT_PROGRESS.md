...
| SC-10 | PARTIAL | SEC client používá limit a retry včetně časového `Retry-After` s omezením čekání na 120 s; databázový zámek zabrání souběžným dávkám SEC ze dvou procesů. Chybí per-provider circuit breaker a checkpoint dlouhého cooldownu. |
