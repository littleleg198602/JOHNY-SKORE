...
| SC-32–33 | PARTIAL | Streamlit ukazuje poslední SEC index/dokument, oddělené neověřené RSS stopy, otevřené i uzavřené otázky s citovanými finding IDs, chyby zdroje a další pokus, stav fronty i tlačítko dávky; Windows .bat a volitelná denní úloha. Instalátor jednou vyžádá kontaktní e-mail SEC, plánovaná dávka jej čte z uživatelského nastavení a nečeká na klávesu při chybě. Chybí skutečné ověřené odpovědi a provozní Windows zkouška. |
